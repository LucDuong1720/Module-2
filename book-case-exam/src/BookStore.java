...
public class BookStore {
    ...
    public BookStore() {
        ...
        // Tính đa hình: từ lớp cha tham chiếu tới đối tượng của lớp con.
        books = new ArrayList<>();
...
//        long id, String name, String description, Date entryDate, double price)
        ...
        do {
            ...
            switch (actionMenu) {
                ...
                case 7:
                    ...
                    break;
                case 8:
                    bookStore.searchByNameOrDescription();
                    break;
                default:
    ...
    private void searchByNameOrDescription() {
        System.out.println("Nhập tên hoặc mô tả bạn muốn tìm kiếm: ");
        String find = scanner.nextLine();
        List<Book> results = new ArrayList<>();
        for (int i = 0; i < books.size(); i++) {
            if (books.get(i).getName().contains(find) || books.get(i).getDescription().contains(find)) {
